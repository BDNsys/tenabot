"""
Django settings for tenabot project.
...
SECRET_KEY = 'django-insecure-$+8h$fn*0lm)o*wplf#d_6(2&#5_hm+hgz9g(%q91%3xmv)1$s'
...
WSGI_APPLICATION = 'tenabot.wsgi.application'
...
LOGGING = {
    ...
    "handlers": {
        ...
        "file": {
           ...
           # "filename":"/home/nazri/Documents/bdn-workspace/tenabot/tenabot/logs/tena.log",
            "filename": os.path.join(BASE_DIR, 'logs', 'tena.log'),
            "formatter": "verbose",
